        ...
        try {
          if (numIn8 && validPassword) {
            ...
            return setPasswordMsg(
              "le mot de passe doit etre entre 4 et 16 chiffres"
            );
          }
        } catch (error) {
          setLoading(false);
    ...
    <div className="p-3 ml-20 mt-4 max-w-lg mx-auto ">
      ...
      >
        ...
        { isUnder16 && (
          <p style={{ marginTop: "-15px" }} className="text-red-600 mt-5">
            {" "}
            l'age doit etre superieur a 16 ans
          </p>
        )}
        <input
          type="email"
        ...
        />
        {(password||confirmPassword) && !passwordMatch && (<p className="text-red-600 mt-5">Passwords do not match</p>)}
        <button
